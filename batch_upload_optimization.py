    ...
    try:
        for COUNTRY_CODE in COUNTRY_CODES:
            ...
            for leadTimeLabel, leadTimeValue in LEAD_TIMES.items():
                ...
                fc.db.startBatchUpload()
                data_to_upload = fc.prepareDataForUpload()  # Assuming this method prepares all the necessary data for upload
                fc.db.uploadData(data_to_upload)  # Perform batch upload
                fc.db.endBatchUpload()
